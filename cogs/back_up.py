...
class BackupCog(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.owner_id = '914812102768734258'  # Укажите ваш Discord ID
        self.gmail_user = 'wizzywodich@gmail.com'
        self.gmail_password = 'uasthgzvimiwplow'
    ...
    async def perform_backup(self):
        ...
        receiver_email = 'wizzywodich@gmail.com'
